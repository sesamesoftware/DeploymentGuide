...
4. Logon Information Section
   ...
   3. SOAP
   4. AccountID
   5. Instance: *Default s7*
   6. Subdomain
   7. UseLegacyAuthentication *Default FALSE*
   8. Batch
   9. Batch Size *Default 200*
   10. First Record Date *Default 1970-01-01*
   11. Date Fields *See below*
   12. Schema Prefix: *UPPER/LOWER, if required.*
   13. Tablename Case: *UPPER/LOWER, if required.*
   14. Select Method
       1.  FIELD_LIST
       2.  STAR
