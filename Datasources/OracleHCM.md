...
2. On the next screen, choose a label for your Datasource.
	1. Recommended: ‘Source Oracle HCM’ or something similar.
	2. Select OracleHCM Template
	3. Click Save
   
3. ![OracleHCM Datasource](../images/oraclescm.png)

4. Logon Information Section
	1. **User**: *Oracle HCM REST API User*
	2. **Password**: *Password for the given user*
	3. **Endpoint**: *Endpoint to the Oracle HCM REST API such as **https://[SERVER]/hcmRestApi/resources/11.13.18.05/** (please include the last forward slash)*
   
5. Click Test
	1. You see Connection Test Successful
   
6. Extended Properties
	1. **Datetime Formats**: Format of the datetime fields defined in the "Date Fields" property The standard Oracle HCM datetime formats are already pre-populated.
	...
	3. **Query String**: Additional URL query parameters (must start with &). For Oracle HCM this is normally to expand the children like such:
	...
	6. **JSONPath**: Path the JSON Array of records. Defaults to "items" as seen in this sample JSON. Most likely will not need to modify.
		![OracleHCM Sample JSON](../images/oraclescmjson.png)
