...
2. On the next screen, choose a label for your Datasource.
   ...
   3. Click Save
   ![QuickBooksDesktop Datasource](../images/QuickBooksDesktop.png)
3. Logon Information Section
   ...
   7.  Date Fields *See below, default timemodified,timecreated*
   8.  Schema Prefix: *UPPER/LOWER, if required.*
