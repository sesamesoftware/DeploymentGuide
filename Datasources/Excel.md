...
2. On the next screen, choose a label for your Datasource.
   ...
   3. Click Save
![Excel Datasource](../images/Excel.png)
1. Logon Information Section
   1. Excel File
      1. The Uniform Resource Identifier (URI) for the Excel resource location.  Must include the full name of the Excel file.  Note that highly formatted Excel files are not supported.
2. If Datasource is being use as a source
   1. Date Fields
